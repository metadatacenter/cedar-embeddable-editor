...
import { CedarArtifactType, CedarReaders } from 'cedar-model-typescript-library';
...
describe('templates that cannot be read', () => {
  ...
  it.each([
    ['an empty object', {}],
    ['a document with no name', { [DocumentKey.atType]: CedarArtifactType.TEMPLATE.getValue() }],
