...
export class CedarInputRridComponent extends AbstractAuthorityInputComponent implements OnInit, AfterViewInit {
  constructor(
    fb: FormBuilder,
  ...
  get descriptor(): AuthorityDescriptor {
    return authorityDescriptorFor(InputType.rrid)!;
  }
}
